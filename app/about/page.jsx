...
const about = () => {
  ...
  return (
    ...
    <div className='about-section' >
        <img src='https://zetapp.in/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FOurMission.13d85461.png&w=3840&q=100' />
        <div className='mission'>
            <text className='their-mission'>OUR MISSION</text>
        </div>
        <div className='text-mission'>
            <text className='text-desc'>Enabling financial inclusion for the next billion Indians & making their Zindagi Set. Building a platform that enables you to sell financial products & earn up to Rs. 1 lakh every month.</text>
        </div>
